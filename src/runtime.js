...
function ctypes_ldouble_to_int (x) { return x | 0; }

//Provides: ctypes_ldouble_of_int
function ctypes_ldouble_of_int(x) { return x }
...
function ctypes_ldouble_cosl(x){ return Math.cos(x)}
//Provides: ctypes_ldouble_sinl
function ctypes_ldouble_sinl(x){ return Math.sin(x)}
//Provides: ctypes_ldouble_tanl
function ctypes_ldouble_tanl(x){ return Math.tan(x)}
//Provides: ctypes_ldouble_acosl
function ctypes_ldouble_acosl(x){ return Math.acos(x)}
//Provides: ctypes_ldouble_asinl
function ctypes_ldouble_asinl(x){ return Math.asin(x)}
//Provides: ctypes_ldouble_atanl
function ctypes_ldouble_atanl(x){ return Math.atan(x)}
//Provides: ctypes_ldouble_coshl
function ctypes_ldouble_coshl(x){ return Math.cosh(x)}
//Provides: ctypes_ldouble_sinhl
function ctypes_ldouble_sinhl(x){ return Math.sinh(x)}
//Provides: ctypes_ldouble_tanhl
function ctypes_ldouble_tanhl(x){ return Math.tanh(x)}
//Provides: ctypes_ldouble_acoshl
function ctypes_ldouble_acoshl(x){ return Math.acosh(x)}
//Provides: ctypes_ldouble_asinhl
function ctypes_ldouble_asinhl(x){ return Math.asinh(x)}
//Provides: ctypes_ldouble_atanhl
function ctypes_ldouble_atanhl(x){ return Math.atanh(x)}
...
function ctypes_ldouble_classify(x){ return (caml_classify_float(x))}
...
//Requires: CtypesComplex
function ctypes_ldouble_complex_real(x) { return x.re }
...
//Requires: ctypes_ldouble_complex_make
function ctypes_ldouble_complex_add(x,y) { return ctypes_ldouble_complex_make(x.re + y.re, x.im + y.im); }

//Provides: ctypes_ldouble_complex_sub
//Requires: ctypes_ldouble_complex_make
function ctypes_ldouble_complex_sub(x,y) { return ctypes_ldouble_complex_make(x.re - y.re, x.im - y.im); }
...
//Requires: caml_failwith
function ctypes_allocate(len, size) {
  caml_failwith("ctypes: ctypes_allocate not implemented");
}

//Provides: ctypes_read
//Requires: caml_failwith
function ctypes_read(prim, ptr) {
  caml_failwith("ctypes: ctypes_read not implemented");
}

//Provides: ctypes_write
//Requires: caml_failwith
function ctypes_write(prim, v, ptr) {
  caml_failwith("ctypes: ctypes_write not implemented");
}

//Provides: ctypes_read_pointer
//Requires: caml_failwith
function ctypes_read_pointer(ptr) {
  caml_failwith("ctypes: ctypes_read_pointer not implemented");
}
...
function integers_uintptr_t_size(unit) { return 4 }

//Provides: integers_intptr_t_size
function integers_intptr_t_size(unit) { return 4 }

//Provides: integers_ptrdiff_t_size
//Requires: caml_failwith
function integers_ptrdiff_t_size(unit) { return 4 }
...
//Requires: caml_failwith
function ctypes_block_address(_) {
  caml_failwith ("ctypes: ctypes_block_address not implemented");
}

//Provides: ctypes_typeof_clock_t
//Requires: caml_failwith
function ctypes_typeof_clock_t(unit) { return 6 }
//Provides: ctypes_typeof_dev_t
//Requires: caml_failwith
function ctypes_typeof_dev_t(unit) { return 6 }
//Provides: ctypes_typeof_ino_t
//Requires: caml_failwith
function ctypes_typeof_ino_t(unit) { return 6 }
//Provides: ctypes_typeof_mode_t
//Requires: caml_failwith
function ctypes_typeof_mode_t(unit) { return 6 }
//Provides: ctypes_typeof_nlink_t
//Requires: caml_failwith
function ctypes_typeof_nlink_t(unit) { return 6 }
//Provides: ctypes_typeof_off_t
//Requires: caml_failwith
function ctypes_typeof_off_t(unit) { return 2 }
//Provides: ctypes_typeof_pid_t
//Requires: caml_failwith
function ctypes_typeof_pid_t(unit) { return 2 }
//Provides: ctypes_typeof_ssize_t
//Requires: caml_failwith
function ctypes_typeof_ssize_t(unit) { return 2 }
//Provides: ctypes_typeof_time_t
//Requires: caml_failwith
function ctypes_typeof_time_t(unit) { return 6 }
//Provides: ctypes_typeof_useconds_t
//Requires: caml_failwith
function ctypes_typeof_useconds_t(unit) { return 6 }
//Provides: ctypes_sizeof_sigset_t
//Requires: caml_failwith
function ctypes_sizeof_sigset_t(unit) { return 4}
//Provides: ctypes_alignmentof_sigset_t
//Requires: caml_failwith
function ctypes_alignmentof_sigset_t(unit) { return 4}
